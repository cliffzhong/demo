...
public class HQLStatementUtil {
    ...
    /*
     * Manager related HQL Statements
     */
    public static final String HQL_SELECT_ALL_MANAGERS = "From Manager";
    public static final String HQL_SELECT_MANAGER_BY_ID = "FROM Manager as m where m.id = :id";
    public static final String HQL_SELECT_MANAGER_BY_NAME = "FROM Manager as m where m.name = :name";
