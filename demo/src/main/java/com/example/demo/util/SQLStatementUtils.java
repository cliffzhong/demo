...
public class SQLStatementUtils {
    ...
    public final static String SQL_SELECT_PROJECTS_BY_STUDENT_LOGIN_NAME = "SELECT p.* FROM PROJECT p, STUDENT_PROJECT sp, STUDENT s where p.ID=sp.PROJECT_ID and sp.STUDENT_ID=s.ID and s.LOGIN_NAME=?";
