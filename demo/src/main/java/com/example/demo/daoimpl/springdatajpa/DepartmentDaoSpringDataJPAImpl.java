...
import com.example.demo.dao.hibernate.DepartmentDao;
...
//    @Autowired
    ...
    public boolean deleteByName(String deptName) {
        return departmentRepository.deleteByName(deptName);
    }
...
//        return departmentRepository.deleteDepartmentUsingId(dept.getId()) > 0;
        return departmentRepository.deleteByName(dept.getName());
    }
